...
//Code Here
let totalPopulation = populations.reduce((acc,curr,currInd,wholeArray) => {
  return acc + curr;
},
0);
...
//Code Here
let myStrongest = monstersInYourPocket.filter((el, index, wholeArray) => {
  return el["CP"] > 200;
});
